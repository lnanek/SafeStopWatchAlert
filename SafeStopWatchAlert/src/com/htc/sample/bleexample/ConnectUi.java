...
public class ConnectUi {
	...
	public ConnectUi(final ConnectActivity aActivity) {
		...
		mForceLocation = (Button) mActivity.findViewById(R.id.forceLocation);
		mForceLocation.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
	...
	public void showForceLocationDialog() {
		...
		final TextView latLabel = new TextView(mActivity);
		latLabel.setText("Latitude:");
		layout.addView(latLabel, params);
		
		final EditText latInput = new EditText(mActivity);
		latInput.setInputType(InputType.TYPE_CLASS_NUMBER);
		layout.addView(latInput, params);
		latInput.setText(Double.toString(ConnectActivity.DANGER_AREA.getLatitude()));

		final TextView lonLabel = new TextView(mActivity);
		lonLabel.setText("Longitude:");
		layout.addView(lonLabel, params);

		final EditText lonInput = new EditText(mActivity);
		lonInput.setInputType(InputType.TYPE_CLASS_NUMBER);
		layout.addView(lonInput, params);
		lonInput.setText(Double.toString(ConnectActivity.DANGER_AREA.getLongitude()));
				
		final AlertDialog.Builder ab = new AlertDialog.Builder(mActivity);
		ab.setTitle("Pretend Latitude & Longitude:");
		ab.setView(layout);
		ab.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				mActivity.forceLocation(location);
			}
		});
		ab.show();
	}
